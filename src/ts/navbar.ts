// navbar.ts - Handles active state for multilingual pages
// Works with structure: en/about-us/index.html and ar/about-us/index.html

/**
 * Sets the active class on the navbar link matching the current page
 * Automatically detects the current page folder (home, about-us, contact, etc.)
 * and highlights the corresponding navbar link
 */
export function setActiveNavLink(): void {
  const currentPath = window.location.pathname;

  // Extract the page folder name (e.g., "about-us" from "/en/about-us/index.html")
